...
import resume from './assets/LeissAminiResume.pdf'
function App() {
    ...
    <div >
      ...
      <footer id="links" className="container-fluid d-flex flex-column justify-content-center align-items-center footerContainer">
        <a href="#home">
          ...
          <a href={resume} download="LeissAminiResume" target="_blank" rel="noopener noreferrer">
